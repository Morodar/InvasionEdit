...
export const BUILDINGS_MAP = new Map<BUILDING_KEYS, EntityMeta>([
  ...
  [
    301,
    { type: 301, model: "LeichteWaffenfabrik.glb", image: "301.jpg", name: "Light Weapon Factory" },
  ],
  [310, { type: 310, model: "Kraftwerk.glb", image: "310.jpg", name: "Power Plant" }],
  [330, { type: 330, model: "Xenitmine.glb", image: "330.jpg", name: "Xenit Mine" }],
  [331, { type: 331, model: "Xenitsilo.glb", image: "331.jpg", name: "Xenit Silo" }],
  [332, { type: 332, model: "Tritiumpumpe.glb", image: "332.jpg", name: "Tritium Pump" }],
  ...
  [
    360,
    {
      ...
      model: "unknown.obj",
      image: "360.jpg",
      name: "Mittlerer Geschütztum (Minikanone)",
    },
  ],
