...
export const SelectedEntityContext = createContext<SelectedEntityContextProps | undefined>(
  undefined,
);
...
export const SelectedEntityContextProvider: React.FC<PropsWithChildren> = ({
  children,
}: PropsWithChildren) => {
  ...
  return (
    <SelectedEntityContext.Provider value={contextValue}>{children}</SelectedEntityContext.Provider>
  );
};
