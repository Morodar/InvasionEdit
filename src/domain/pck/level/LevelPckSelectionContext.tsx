...
export const LevelPckSelectionContext = createContext<LevelPckSelectionContextProps | undefined>(
  undefined,
);
...
export const LevelPckSelectionContextProvider: React.FC<PropsWithChildren> = ({
  children,
}: PropsWithChildren) => {
  ...
  return (
    <LevelPckSelectionContext.Provider value={value}>{children}</LevelPckSelectionContext.Provider>
  );
};
