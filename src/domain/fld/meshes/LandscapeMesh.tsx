...
import {
  FldPrimaryAction,
  useFldPrimaryActionContext,
} from "../action-bar/FldPrimaryActionContext";
...
export const LandscapeMesh = () => {
  ...
  return (
    <LandscapeLayerMesh map={fldFile} primaryAction={primaryAction} showWireframe={showWireframe} />
  );
};
