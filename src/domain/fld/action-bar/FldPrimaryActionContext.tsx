...
export const FldPrimaryActionContext = createContext<FldPrimaryActionContextProps | undefined>(
  undefined,
);
...
export const FldPrimaryActionContextProvider: React.FC<PropsWithChildren> = ({
  children,
}: PropsWithChildren) => {
  ...
  return (
    <FldPrimaryActionContext.Provider value={contextValue}>
      {children}
    </FldPrimaryActionContext.Provider>
  );
};
