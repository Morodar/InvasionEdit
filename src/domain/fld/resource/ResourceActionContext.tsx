...
export const ResourceActionContext = createContext<ResourceActionContextProps | undefined>(
  undefined,
);
...
export const ResourceActionContextProvider: React.FC<PropsWithChildren> = ({
  children,
}: PropsWithChildren) => {
  ...
  return (
    <ResourceActionContext.Provider value={contextValue}>{children}</ResourceActionContext.Provider>
  );
};
