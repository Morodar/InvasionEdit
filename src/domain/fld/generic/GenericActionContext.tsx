...
export const GenericActionContextProvider: React.FC<PropsWithChildren> = ({
  children,
}: PropsWithChildren) => {
  ...
  return (
    <GenericActionContext.Provider value={contextValue}>{children}</GenericActionContext.Provider>
  );
};
