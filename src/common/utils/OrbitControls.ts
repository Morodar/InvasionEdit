...
class OrbitControls extends EventDispatcher {
    ...
    constructor(object: PerspectiveCamera | OrthographicCamera, domElement?: HTMLElement) {
        ...
        this.reset = (): void => {
            ...
            scope.dispatchEvent(changeEvent as never);
        ...
        const scope: OrbitControls = this;
        ...
        const pointerPositions: Record<string, Vector2> = {};
        ...
        function onPointerUp(event: PointerEvent) {
            ...
            scope.dispatchEvent(endEvent as never);
        ...
        function onMouseDown(event: MouseEvent) {
            ...
            if (state !== STATE.NONE) {
                scope.dispatchEvent(startEvent as never);
            }
        }
