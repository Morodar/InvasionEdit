    ...
    <Dialog onClose={onClose} open={open}>
      ...
      <DialogContent>
        <FormGroup>
          <FormControlLabel
            control={
              <Switch checked={debugSettings.showAllLayers} onChange={handleShowAllLayersChange} />
            }
            label={t("fld-editor.debug.show-all-layers")}
          />
          <FormControlLabel
            control={
              <Switch checked={debugSettings.showDebugCube} onChange={handleDebugCubeChange} />
            }
          ...
          <FormControlLabel
            control={
              <Switch
                checked={debugSettings.showDebugCube3x3}
                onChange={handleDebugCubeChange3x3}
              />
            }
          ...
          <FormControlLabel
            control={
              <Switch
                checked={debugSettings.showEntitiesList}
                onChange={handleShowEntitiesListChange}
              />
            }
